...
class AllPendingRegisterRequestTable extends GetView<DashboardScreenController> {
  const AllPendingRegisterRequestTable({super.key});
        ...
        actions: [
          Padding(
            ...
            child: TextButton(
                    ...
                    await dashboardScreenController.rejectRegistrationRequests();
           ...
           Padding(
             ...
             child: TextButton(
                  ...
                  onPressed: () async {
                    ...
                    await dashboardScreenController.archivedRegistrationRequests();
Navigator.pop(context, 'accept');
                },
          ...
          Padding(
            ...
            child: TextButton(
                  ...
                  onPressed: () async {
                    ...
                    await dashboardScreenController.acceptRegistrationRequests();
Navigator.pop(context, 'accept');
                },
