...
class AllRegisterRequestTable extends GetView<DashboardScreenController> {
  const AllRegisterRequestTable({super.key});
...
DataRow recentDataRow(BuildContext context, RegisterRequest fileInfo) {
  return DataRow(
      ...
      onSelectChanged: (bool? selected) {
        if (selected != null && selected) _handleRowTap(context, fileInfo);
      });
}
