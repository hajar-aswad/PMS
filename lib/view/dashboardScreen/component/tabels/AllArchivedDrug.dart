...
class AllArchivedAddDrugRequestTable
    extends GetView<DashboardScreenController> {
  @override
          ...
          SizedBox(
            ...
            child: DataTable(
              ...
              columns: [
                ...
                const DataColumn(
                    label: Text("note  and  description about drug ")),
              ...
              rows: List.generate(
                ...
                (index) =>
                    recentDataRow(context, controller.DrugRequests[index]),
              ),
            ),
          )
        ],
      ...
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text("Decsription  and note about drug : ",
                style: TextStyle(color: Colors.white54, fontSize: 12)),
            Text(' ${fileInfo.notes}'),
            const Text("type of Date of send  ",
                style: TextStyle(color: Colors.white54, fontSize: 12)),
            Text('${fileInfo.date}'),
          ...
          Padding(
            ...
            child: TextButton(
              onPressed: () async {
                ...
                await dashboardScreenController.deleteDrugRequests();
          ...
          Padding(
            ...
            child: TextButton(
              onPressed: () async {
                ...
                //  await dashboardScreenController.unarchivedDrugRequests();
                Navigator.pop(context, 'accept');
              },
